...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rating.threadid'
        db.add_column(u'hyperkitty_rating', 'threadid',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Rating.threadid'
        db.delete_column(u'hyperkitty_rating', 'threadid')
    ...
    models = {
        ...
        u'hyperkitty.rating': {
            ...
            'threadid': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
